...
function ValidateThird(props) {
        ...
        const leeFacturas = async () => {
            ...
            await axios({
                ...
                if (newDet.length > 0) {
                    ...
                    //console.log("FACTURAS LEIDAS : ", newDet[0].data.id);
                    /*
    ...
    const crearClientes = () => {
        ...
        for (var i = 0; i < longitud; i++) {
            ...
            formdata.append("active", datosClientesFacturas[i].active);
            formdata.append("address", datosClientesFacturas[i].address);
            formdata.append("apellido", datosClientesFacturas[i].apellido);
            formdata.append("branch_office", datosClientesFacturas[i].branch_office);
            formdata.append("check_digit", datosClientesFacturas[i].check_digit);
            formdata.append("city_code", datosClientesFacturas[i].city_code);
            formdata.append("ciudad", datosClientesFacturas[i].ciudad);
            formdata.append("code", datosClientesFacturas[i].code);
            formdata.append("comments", datosClientesFacturas[i].comments);
            formdata.append("commercial_name", datosClientesFacturas[i].commercial_name);
            formdata.append("country_code", datosClientesFacturas[i].country_code);
            formdata.append("email", datosClientesFacturas[i].email);
            formdata.append("estado", datosClientesFacturas[i].estado);
            formdata.append("extension", datosClientesFacturas[i].extension);
            formdata.append("fecha", datosClientesFacturas[i].fecha);
            formdata.append("first_name", datosClientesFacturas[i].first_name);
            formdata.append("id_type", datosClientesFacturas[i].id_type);
            formdata.append("identification", datosClientesFacturas[i].identification);
            formdata.append("indicative", datosClientesFacturas[i].indicative);
            formdata.append("indicativofacturacion", datosClientesFacturas[i].indicativofacturacion);
            formdata.append("last_name", datosClientesFacturas[i].last_name);
            formdata.append("nombre", datosClientesFacturas[i].nombre);
            formdata.append("number", datosClientesFacturas[i].number);
            formdata.append("person_type", datosClientesFacturas[i].person_type);
            formdata.append("postal_code", datosClientesFacturas[i].postal_code);
            formdata.append("state_code", datosClientesFacturas[i].state_code);
            formdata.append("sucursal", datosClientesFacturas[i].sucursal);
            formdata.append("tipoderegimen", datosClientesFacturas[i].tipoderegimen);
            formdata.append("tipotercero", datosClientesFacturas[i].tipotercero);
            formdata.append("type", datosClientesFacturas[i].type);
            formdata.append("usuarioasignado", datosClientesFacturas[i].usuarioasignado);
            formdata.append("vat_responsible", datosClientesFacturas[i].vat_responsible);

            //console.log("PARAMETROS : ", params);

            fetch("https://sitbusiness.co/cyclewear/api/113", {
                method: "POST",
                body: formdata,
            }).then(res => {
